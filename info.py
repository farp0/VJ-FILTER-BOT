...
BOT_TOKEN = environ.get('BOT_TOKEN', "6550137931:AAFl4Vh1kWsIiDOc015Y-wNrw-EZcV_mAoo")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Mohd_ali:Mohd_ali@cluster0.62v8oyx.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Mohd_ali")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'themoviesmindsupport')
...
URL = "https://movies-bot-3trk.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://movies-bot-3trk.onrender.com".format(FQDN, PORT)
